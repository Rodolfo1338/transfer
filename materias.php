...
<html lang="es">
    ...
    <body>
            ...
            <div id="content">
                ...
                <div id="Idcarreras">               
                    <div class="container-fluid">                
                        <div class="row">       
                            <div class="col">        
                                <button @click="btnAlta" class="btn btn-success shadow" title="Nuevo"><i class="fas fa-plus"></i> Agregar Materia</i></button>
                            </div>
                        </div> 
                        <div class="row mt-5">
                            <div class="col-lg-12">                    
                                <table class="table table-striped table-hover shadow">
                                    ...
                                    <tbody>
                                        <tr v-for="(dato,indice) of datos">                                
                                            <td>{{dato.intidmateria}}</td>                                
                                            <td>{{dato.vchmateria}}</td>
                                            <td class="size-bottons-table">
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-secondary" title="Editar" @click="btnEditar(dato.intidmateria,dato.vchmateria)"><i class="fas fa-pencil-alt"></i></button>    
                                                    <button class="btn btn-danger" title="Eliminar" @click="btnBorrar(dato.intidmateria,dato.vchmateria)"><i class="fas fa-trash-alt"></i></button>      
                                                </div>
                                            </td>
                                        </tr>   
                                    </tbody>
        ...
        <!--Código custom -->          
        <script src="js/materias.main.js"></script> 

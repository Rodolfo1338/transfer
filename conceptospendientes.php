            ...
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    ...
                    <label class="col-sm-3 col-form-label">Cuenta</label><div class="col-sm-7"><input id="cuatrimestre" type="number" class="form-control"></div>
                    ...
                    <label class="col-sm-3 col-form-label">Estado</label><div class="col-sm-7"><input id="curp" type="text" class="form-control"></div>
